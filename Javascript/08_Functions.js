...
console.log(formatPrice(5.5));
console.log(formatPrice(99.999));
console.log("Un callback es una función que le pasas a otra función para que la ejecute");