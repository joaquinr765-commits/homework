...
searchCountryBtn.addEventListener("click", async () => {
   ...
   if (countryInput === "") {
    countryInput.textContent = "Please type a country name."
    return
   } else {
    countryInput.innerHTML = "https://restcountries.com/v3.1/name/" + encodeURIComponent(countryName) + "?fields=name,capital,region,population";
   }
